...
import { PositronNotebooksExtension } from '../positron-notebooks.js';

export const extensionId = 'positron.positron-notebooks-helpers';
...
export async function activateNotebooksExtension(): Promise<PositronNotebooksExtension> {
	const extension = extensions.getExtension<PositronNotebooksExtension>(extensionId);
